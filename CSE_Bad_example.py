...
# Transportation
truck_capacity = 5_000  # what's the maximum material one car can transport - in metres^3
...
with CodeTimer('No CSE used - 20_000 cases'):
    for i in range(20_000):
        ...
        total_weight = number_of_pingpongs_in_house * pingpong_weight
    ...
    print(f'Total number of all balls: {number_of_pingpongs_in_house}. Total weight of all balls: {total_weight}. Total cars needed: {trucks_needed}')
